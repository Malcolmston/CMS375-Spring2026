...
<body class="min-h-screen bg-gray-100 flex items-center justify-center">
    <div class="bg-white rounded-2xl shadow-md w-full max-w-md p-8">
        <h1 class="text-2xl font-bold text-gray-800 mb-2 text-center">Staff Login</h1>
        <p class="text-sm text-gray-500 text-center mb-6">Sign in with your employee credentials</p>

        <form method="POST" action="/staff/login" class="space-y-5">
            <div>
