...
<body class="min-h-screen bg-gray-100 flex items-center justify-center">
    <div class="bg-white rounded-2xl shadow-md w-full max-w-md p-8">
        ...
        <p class="text-sm text-gray-500 text-center mb-6">Restricted access — authorised personnel only</p>
        ...
        <form method="POST" action="/admin/login" class="space-y-5">
            ...
            <button
                type="submit"
                class="w-full bg-red-600 hover:bg-red-700 text-white font-semibold rounded-lg px-4 py-2 text-sm transition-colors"
            >
                Sign In
            </button>
        </form>
